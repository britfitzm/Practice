...
void help_shellby(void);
void help_shellby_alias(void);
void help_shellby_cd(void);
void help_shellby_exit(void);
void help_shellby_help(void);

/**
 * help_shellby - Displays all possible builtin shellby commands.
 */
void help_shellby(void)
{
...
/**
 * help_shellby_alias - Displays information on the shellby builtin command 'alias'.
 */
void help_shellby_alias(void)
{
...
/**
 * help_shellby_cd - Displays information on the shellby builtin command 'cd'.
 */
void help_shellby_cd(void)
{
...
/**
 * help_shellby_exit - Displays information on the shellby builtin command 'exit'.
 */
void help_shellby_exit(void)
{
...
/**
 * help_shellby_help - Displays information on the shellby builtin command 'help'.
 */
void help_shellby_help(void)
{
